...
void ModelPart::setColour(const unsigned char R, const unsigned char G, const unsigned char B) {
    colour.Set(R,G,B);
    if (actor != nullptr) {
        actor->GetProperty()->SetColor(double(colour.GetRed())/255, double(colour.GetGreen())/255,double(colour.GetBlue())/255);
    }
}
...
void ModelPart::loadSTL( QString fileName ) {
     ...
     */
    file = vtkSmartPointer<vtkSTLReader>::New();               /**< Datafile from which part loaded */
