...
RenderThread::RenderThread(QObject *parent, vtkSmartPointer<vtkRenderer> renderer,
...
void RenderThread::run()
{
    ...
    // vtkSmartPointer<vtkCompositePolyDataMapper> bigMapper = vtkCompositePolyDataMapper::New();
    vtkActor *a;
    // vtkMapper *m;
...
void RenderThread::issueCommand(int cmd, double value)
{
    ...
    case RE_RENDER:
        // Cannot call Render() on renderWindow directly here, since it will be executed on main thread. It need to be
        // called from renderThread itself. - Chanon Yothavut
        this->reRender = true;
        break;
    }
}
